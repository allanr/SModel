...
public class Store
{
   ...
   @Property( name = PROPERTY_PIT, partner = Pit.PROPERTY_STORE, kind = ReferenceHandler.ReferenceKind.TO_ONE,
   ...
   @Property( name = PROPERTY_PIT )
   public Store withPit (Pit value)
   {
      setPit (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PLAYER, partner = Player.PROPERTY_STORE, kind = ReferenceHandler.ReferenceKind.TO_ONE,
         adornment = ReferenceHandler.Adornment.NONE)
   ...
   public boolean setPlayer (Player value)
   {
      ...
      if (this.player != value)
      {
         ...
         {
            this.player = null;
            oldValue.removeFromStore (this);
         }
         this.player = value;

         if (value != null)
         {
            value.addToStore (this);
         }
         changed = true;
   ...
   @Property( name = PROPERTY_PLAYER )
   public Store withPlayer (Player value)
   {
      setPlayer (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_SEED )
   public Store withSeed (Seed value)
   {
      addToSeed (value);
      return this;
   }

   public Store withoutSeed (Seed value)
   {
